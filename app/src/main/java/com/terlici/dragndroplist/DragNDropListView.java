...
public class DragNDropListView extends ListView {
		...
		switch (action) {
			...
			default:
				...
				if (mStartPosition != INVALID_POSITION) {
					...
					int actualPosition = pointToPosition(mDragStartX, y);
					if (actualPosition == INVALID_POSITION) {
						actualPosition = pointToPosition(x, y);
					}
					if (actualPosition > (getCount() - getFooterViewsCount()) - 1) { actualPosition = INVALID_POSITION; }
	...
	private void startDrag(int childIndex, int y) {
		...
		if (mDragNDropListener != null) { mDragNDropListener.onItemDrag(this, item, mStartPosition, id); }
	...
	private void stopDrag(int childIndex, int endPosition) {
		...
		if (endPosition != INVALID_POSITION) {
			...
			if (mDragNDropListener != null) { mDragNDropListener.onItemDrop(this, item, mStartPosition, endPosition, id); }
